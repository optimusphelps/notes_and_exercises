...
\newcommand{\assignmentTitle}{Chapter\ \#3} % Assignment title or name
...
\begin{question}
\questiontext{\input{problems/chapter_2/prob_#1.tex}}
\answer{\input{solutions/chapter_2/sol_#1.tex}}
\end{question}
}
%----------------------------------------------------------------------------------------
